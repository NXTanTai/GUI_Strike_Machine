...
################################################################################
## Form generated from reading UI file 'tech_link_theme_backup_3.ui'
##
...
"border-radius:15px;")
        ...
        self.start_btn = QPushButton(self.running_light_52)
        ...
        self.start_btn.setStyleSheet(u"border: 2px solid #E5E5E5; \n"
"border-radius: 10px;\n"
"color: #10B981; \n"
"padding-right: 3px;")
        icon7 = QIcon()
        ...
        self.horizontalLayout_439.addWidget(self.start_btn)
        ...
        self.stop_btn = QPushButton(self.error_light_52)
        ...
        self.stop_btn.setStyleSheet(u"border: 2px solid #E5E5E5; \n"
"border-radius: 10px;\n"
"color: #F90A0A; \n"
"padding-right: 3px;")
        icon8 = QIcon()
        ...
        self.horizontalLayout_441.addWidget(self.stop_btn)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u":/newPrefix/broom.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"border-radius: 20px;")
        self.pushButton_109.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_111.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_113.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_115.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_117.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_119.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_121.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_125.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_129.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_127.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_107.setIcon(icon8)
...
"border-radius: 20px;")
        self.pushButton_103.setIcon(icon8)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_btn.setText(QCoreApplication.translate("MainWindow", u"Running", None))
