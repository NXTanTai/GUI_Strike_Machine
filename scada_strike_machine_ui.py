...
"}")
        ...
        self.history_page_btn.setFont(font3)
        icon7 = QIcon()
        ...
        self.alarm_page_btn = QPushButton(self.left_side_menu_widget)
        self.left_side_btn_group.addButton(self.alarm_page_btn)
        self.alarm_page_btn.setObjectName(u"alarm_page_btn")
        sizePolicy.setHeightForWidth(self.alarm_page_btn.sizePolicy().hasHeightForWidth())
        self.alarm_page_btn.setSizePolicy(sizePolicy)
        self.alarm_page_btn.setFont(font3)
        self.alarm_page_btn.setStyleSheet(u"QPushButton:checked {\n"
"	border-right: 5px solid rgb(255, 0, 0);\n"
"	color: rgb(255, 0, 0);\n"
"}")
        icon8 = QIcon()
        icon8.addFile(u":/Icons/bell.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u":/Icons/bell (1).png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.alarm_page_btn.setIcon(icon8)
        self.alarm_page_btn.setIconSize(QSize(24, 24))
        self.alarm_page_btn.setCheckable(True)

        self.verticalLayout_4.addWidget(self.alarm_page_btn)
...
"padding-right: 3px;")
        icon9 = QIcon()
        icon9.addFile(u":/Icons/record-button (1).png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.stop_light.setIcon(icon9)
...
"padding-right: 3px;")
        icon10 = QIcon()
        icon10.addFile(u":/Icons/record-button.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.start_light.setIcon(icon10)
...
"}")
        ...
        icon11 = QIcon()
        icon11.addFile(u":/Icons/data-cleaning.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.clear_data_btn.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/Icons/folder-upload.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.new_data_btn.setIcon(icon12)
...
"}")
        ...
        self.stacked_pressure_sv_a_11 = QStackedWidget(self.widget_303)
        self.stacked_pressure_sv_a_11.setObjectName(u"stacked_pressure_sv_a_11")
        self.stacked_pressure_sv_a_11.setStyleSheet(u"\n"
"	border: none;")
        self.inf_pressure_sv_a_11 = QWidget()
        self.inf_pressure_sv_a_11.setObjectName(u"inf_pressure_sv_a_11")
        self.inf_pressure_sv_a_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_6 = QHBoxLayout(self.inf_pressure_sv_a_11)
        self.horizontalLayout_6.setSpacing(0)
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.horizontalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.pushButton = QPushButton(self.inf_pressure_sv_a_11)
        self.pushButton.setObjectName(u"pushButton")
        sizePolicy.setHeightForWidth(self.pushButton.sizePolicy().hasHeightForWidth())
        self.pushButton.setSizePolicy(sizePolicy)
        icon13 = QIcon()
        icon13.addFile(u":/Icons/loop.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton.setIcon(icon13)
        self.pushButton.setIconSize(QSize(24, 24))

        self.horizontalLayout_6.addWidget(self.pushButton)

        self.stacked_pressure_sv_a_11.addWidget(self.inf_pressure_sv_a_11)
        self.count_pressure_sv_a_11 = QWidget()
        self.count_pressure_sv_a_11.setObjectName(u"count_pressure_sv_a_11")
        self.count_pressure_sv_a_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_5 = QHBoxLayout(self.count_pressure_sv_a_11)
        self.horizontalLayout_5.setSpacing(0)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.pressure_sv_a_11 = QSpinBox(self.count_pressure_sv_a_11)
...
"}")
        ...
        self.horizontalLayout_5.addWidget(self.pressure_sv_a_11)

        self.stacked_pressure_sv_a_11.addWidget(self.count_pressure_sv_a_11)

        self.horizontalLayout_577.addWidget(self.stacked_pressure_sv_a_11)

        self.horizontalLayout_577.setStretch(0, 1)
        self.horizontalLayout_577.setStretch(2, 1)
        ...
        self.set_cycle_a_btn.setFont(font3)
...
"}")
        ...
        self.set_cycle_a_btn.setIcon(icon14)
...
"}")
        ...
        self.gridLayout.addWidget(self.line_4, 1, 5, 3, 1)
...
"}")
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Icons/eraser_hover.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.clear_group_a.setIcon(icon15)
        ...
        self.gridLayout.addLayout(self.header_group_layout_1, 0, 2, 1, 1)
...
"}")
        ...
        self.clear_group_b.setIcon(icon15)
...
"}")
        ...
        self.clear_group_c.setIcon(icon15)
        ...
        self.gridLayout.addWidget(self.line_5, 1, 3, 3, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.label_name_2, 2, 0, 1, 1)
...
"}")
        ...
        self.stacked_pressure_sv_c_11 = QStackedWidget(self.widget_337)
        self.stacked_pressure_sv_c_11.setObjectName(u"stacked_pressure_sv_c_11")
        self.stacked_pressure_sv_c_11.setStyleSheet(u"\n"
"	border: none;")
        self.inf_pressure_sv_c_11 = QWidget()
        self.inf_pressure_sv_c_11.setObjectName(u"inf_pressure_sv_c_11")
        self.inf_pressure_sv_c_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_34 = QHBoxLayout(self.inf_pressure_sv_c_11)
        self.horizontalLayout_34.setSpacing(0)
        self.horizontalLayout_34.setObjectName(u"horizontalLayout_34")
        self.horizontalLayout_34.setContentsMargins(0, 0, 0, 0)
        self.pushButton_3 = QPushButton(self.inf_pressure_sv_c_11)
        ...
        self.stacked_pressure_sv_c_11.addWidget(self.inf_pressure_sv_c_11)
        self.count_pressure_sv_c_11 = QWidget()
        self.count_pressure_sv_c_11.setObjectName(u"count_pressure_sv_c_11")
        self.count_pressure_sv_c_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_42 = QHBoxLayout(self.count_pressure_sv_c_11)
        self.horizontalLayout_42.setSpacing(0)
        self.horizontalLayout_42.setObjectName(u"horizontalLayout_42")
        self.horizontalLayout_42.setContentsMargins(0, 0, 0, 0)
        self.pressure_sv_c_11 = QSpinBox(self.count_pressure_sv_c_11)
...
"}")
        ...
        self.horizontalLayout_42.addWidget(self.pressure_sv_c_11)

        self.stacked_pressure_sv_c_11.addWidget(self.count_pressure_sv_c_11)

        self.horizontalLayout_581.addWidget(self.stacked_pressure_sv_c_11)

        self.horizontalLayout_581.setStretch(0, 1)
        self.horizontalLayout_581.setStretch(2, 1)
        ...
        self.set_cycle_c_btn.setFont(font3)
...
"}")
        icon16 = QIcon()
        icon16.addFile(u":/Icons/infinite-cycle.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon16.addFile(u":/Icons/arrows-repeat-1.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon16.addFile(u":/newPrefix/rotate-reverse-white.png", QSize(), QIcon.Mode.Selected, QIcon.State.On)
        self.set_cycle_c_btn.setIcon(icon16)
        ...
        self.gridLayout.addWidget(self.group_3_val_1, 1, 6, 1, 1)
...
"}")
        ...
        self.stacked_pressure_sv_b_11 = QStackedWidget(self.widget_335)
        self.stacked_pressure_sv_b_11.setObjectName(u"stacked_pressure_sv_b_11")
        self.stacked_pressure_sv_b_11.setStyleSheet(u"\n"
"	border: none;")
        self.inf_pressure_sv_b_11 = QWidget()
        self.inf_pressure_sv_b_11.setObjectName(u"inf_pressure_sv_b_11")
        self.inf_pressure_sv_b_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_25 = QHBoxLayout(self.inf_pressure_sv_b_11)
        self.horizontalLayout_25.setSpacing(0)
        self.horizontalLayout_25.setObjectName(u"horizontalLayout_25")
        self.horizontalLayout_25.setContentsMargins(0, 0, 0, 0)
        self.pushButton_2 = QPushButton(self.inf_pressure_sv_b_11)
        ...
        self.stacked_pressure_sv_b_11.addWidget(self.inf_pressure_sv_b_11)
        self.count_pressure_sv_b_11 = QWidget()
        self.count_pressure_sv_b_11.setObjectName(u"count_pressure_sv_b_11")
        self.count_pressure_sv_b_11.setStyleSheet(u"\n"
"	border: none;")
        self.horizontalLayout_26 = QHBoxLayout(self.count_pressure_sv_b_11)
        self.horizontalLayout_26.setSpacing(0)
        self.horizontalLayout_26.setObjectName(u"horizontalLayout_26")
        self.horizontalLayout_26.setContentsMargins(0, 0, 0, 0)
        self.pressure_sv_b_11 = QSpinBox(self.count_pressure_sv_b_11)
...
"}")
        ...
        self.horizontalLayout_26.addWidget(self.pressure_sv_b_11)

        self.stacked_pressure_sv_b_11.addWidget(self.count_pressure_sv_b_11)

        self.horizontalLayout_579.addWidget(self.stacked_pressure_sv_b_11)

        self.horizontalLayout_579.setStretch(0, 1)
        self.horizontalLayout_579.setStretch(2, 1)
        ...
        self.set_cycle_b_btn.setFont(font3)
...
"    color: #0B7EC8;\n"
"}")
        self.set_cycle_b_btn.setIcon(icon14)
...
"}")
        ...
        self.gridLayout.addWidget(self.group_2_val_3, 3, 4, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.group_3_val_4, 5, 6, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.label_name_5, 6, 0, 1, 1)
...
"}")
        ...
        font16.setBold(True)
        self.refuel_btn_b.setFont(font16)
...
"}")
        icon17 = QIcon()
        icon17.addFile(u":/Icons/gas-pump-alt.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.refuel_btn_b.setIcon(icon17)
        ...
        self.gridLayout.addWidget(self.widget_51, 16, 4, 1, 1)
...
"}")
        ...
        self.refuel_btn_a.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.refuel_btn_a.setIcon(icon17)
        ...
        self.gridLayout.addWidget(self.widget_44, 16, 2, 1, 1)
        ...
        self.vacuum_btn_b.setFont(font16)
...
"}")
        icon18 = QIcon()
        icon18.addFile(u":/Icons/pump.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.vacuum_btn_b.setIcon(icon18)
        ...
        self.gridLayout.addWidget(self.widget_45, 17, 4, 1, 1)
        ...
        self.refuel_btn_c.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.refuel_btn_c.setIcon(icon17)
        ...
        self.gridLayout.addWidget(self.widget_42, 16, 6, 1, 1)
        ...
        self.vacuum_btn_a.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.vacuum_btn_a.setIcon(icon18)
...
"}")
        ...
        self.gridLayout.addWidget(self.group_3_val_12, 14, 6, 1, 1)
...
"}")
        ...
        self.vacuum_btn_c.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.vacuum_btn_c.setIcon(icon18)
        ...
        self.gridLayout.addWidget(self.widget_46, 17, 6, 1, 1)
        ...
        self.heat_btn_c.setFont(font16)
...
"}")
        icon19 = QIcon()
        icon19.addFile(u":/Icons/heat.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.heat_btn_c.setIcon(icon19)
        ...
        self.gridLayout.addWidget(self.widget_49, 18, 6, 1, 1)
        ...
        self.heat_btn_a.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.heat_btn_a.setIcon(icon19)
...
"}")
        ...
        self.heat_btn_b.setFont(font16)
...
"    border-radius: 8px;\n"
"}")
        self.heat_btn_b.setIcon(icon19)
...
"}")
        ...
        self.bt_l_alm_value.setFont(font17)
...
"}")
        ...
        self.bt_t3_offset_value.setFont(font17)
...
"}")
        ...
        self.at_t3_offset_value.setFont(font17)
...
"}")
        ...
        self.bt_h_alm_value.setFont(font17)
...
"}")
        ...
        self.at_h_alm_value.setFont(font17)
...
"}")
        ...
        self.ct_t2_offset_value.setFont(font17)
...
"}")
        ...
        self.at_l_alm_value.setFont(font17)
...
"}")
        ...
        self.ct_t1_offset_value.setFont(font17)
...
"}")
        ...
        self.bt_t1_offset_value.setFont(font17)
...
"}")
        ...
        self.bt_t2_offset_value.setFont(font17)
...
"}")
        ...
        self.ct_h_alm_value.setFont(font17)
...
"}")
        ...
        self.ct_l_alm_value.setFont(font17)
...
"}")
        ...
        self.ct_t3_offset_value.setFont(font17)
...
"}")
        ...
        self.t0_offset_value.setFont(font17)
...
"}")
        ...
        self.t0_l_alm_value.setFont(font17)
...
"}")
        ...
        self.t0_h_alm_value.setFont(font17)
...
"}")
        ...
        self.at_t1_offset_value.setFont(font17)
...
"}")
        ...
        self.at_t2_offset_value.setFont(font17)
...
"}")
        ...
        self.layoutWidget.setGeometry(QRect(50, 50, 651, 441))
        self.connection_status_layout_2 = QHBoxLayout(self.layoutWidget)
        self.connection_status_layout_2.setSpacing(0)
        self.connection_status_layout_2.setObjectName(u"connection_status_layout_2")
        self.connection_status_layout_2.setContentsMargins(5, 5, 5, 5)
        self.plc_io_btn_2 = QPushButton(self.layoutWidget)
...
"image: url(:/Icons/Industrial_Furnace.PNG);")
        ...
        self.connection_status_layout_2.addWidget(self.plc_io_btn_2)

        self.i_o_group_4 = QGroupBox(self.page_2)
        self.i_o_group_4.setObjectName(u"i_o_group_4")
        self.i_o_group_4.setGeometry(QRect(60, 560, 301, 521))
        font19 = QFont()
        font19.setFamilies([u"Segoe UI"])
        font19.setPointSize(12)
        font19.setBold(True)
        self.i_o_group_4.setFont(font19)
        ...
        self.i_o_group_1_switch_25 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_25.setObjectName(u"i_o_group_1_switch_25")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_25.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_25.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_25.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_30 = QWidget()
        self.off_light_30.setObjectName(u"off_light_30")
        self.horizontalLayout_616 = QHBoxLayout(self.off_light_30)
        self.horizontalLayout_616.setObjectName(u"horizontalLayout_616")
        self.horizontalLayout_616.setContentsMargins(0, 0, 0, 0)
        self.pushButton_100 = QPushButton(self.off_light_30)
        ...
        font20.setBold(True)
        self.pushButton_100.setFont(font20)
        self.pushButton_100.setIcon(icon9)
        self.pushButton_100.setIconSize(QSize(24, 24))

        self.horizontalLayout_616.addWidget(self.pushButton_100)

        self.i_o_group_1_switch_25.addWidget(self.off_light_30)
        self.on_light_30 = QWidget()
        self.on_light_30.setObjectName(u"on_light_30")
        self.horizontalLayout_617 = QHBoxLayout(self.on_light_30)
        self.horizontalLayout_617.setObjectName(u"horizontalLayout_617")
        self.horizontalLayout_617.setContentsMargins(0, 0, 0, 0)
        self.pushButton_101 = QPushButton(self.on_light_30)
        ...
        font21.setBold(True)
        self.pushButton_101.setFont(font21)
        self.pushButton_101.setIcon(icon10)
        self.pushButton_101.setIconSize(QSize(24, 24))

        self.horizontalLayout_617.addWidget(self.pushButton_101)

        self.i_o_group_1_switch_25.addWidget(self.on_light_30)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_25, 11, 2, 1, 1)

        self.serial_name_13 = QLabel(self.i_o_group_4)
        self.serial_name_13.setObjectName(u"serial_name_13")
        font22 = QFont()
        font22.setPointSize(12)
        font22.setBold(True)
        self.serial_name_13.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_13, 12, 0, 1, 1)

        self.i_o_group_1_switch_24 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_24.setObjectName(u"i_o_group_1_switch_24")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_24.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_24.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_24.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_29 = QWidget()
        self.off_light_29.setObjectName(u"off_light_29")
        self.horizontalLayout_614 = QHBoxLayout(self.off_light_29)
        self.horizontalLayout_614.setObjectName(u"horizontalLayout_614")
        self.horizontalLayout_614.setContentsMargins(0, 0, 0, 0)
        self.pushButton_98 = QPushButton(self.off_light_29)
        ...
        self.pushButton_98.setFont(font20)
        self.pushButton_98.setIcon(icon9)
        self.pushButton_98.setIconSize(QSize(24, 24))

        self.horizontalLayout_614.addWidget(self.pushButton_98)

        self.i_o_group_1_switch_24.addWidget(self.off_light_29)
        self.on_light_29 = QWidget()
        self.on_light_29.setObjectName(u"on_light_29")
        self.horizontalLayout_615 = QHBoxLayout(self.on_light_29)
        self.horizontalLayout_615.setObjectName(u"horizontalLayout_615")
        self.horizontalLayout_615.setContentsMargins(0, 0, 0, 0)
        self.pushButton_99 = QPushButton(self.on_light_29)
        ...
        self.pushButton_99.setFont(font21)
        self.pushButton_99.setIcon(icon10)
        self.pushButton_99.setIconSize(QSize(24, 24))

        self.horizontalLayout_615.addWidget(self.pushButton_99)

        self.i_o_group_1_switch_24.addWidget(self.on_light_29)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_24, 9, 2, 1, 1)

        self.serial_name_10 = QLabel(self.i_o_group_4)
        self.serial_name_10.setObjectName(u"serial_name_10")
        self.serial_name_10.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_10, 9, 0, 1, 1)

        self.serial_name_9 = QLabel(self.i_o_group_4)
        self.serial_name_9.setObjectName(u"serial_name_9")
        self.serial_name_9.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_9, 8, 0, 1, 1)

        self.i_o_group_1_switch_23 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_23.setObjectName(u"i_o_group_1_switch_23")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_23.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_23.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_23.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_28 = QWidget()
        self.off_light_28.setObjectName(u"off_light_28")
        self.horizontalLayout_612 = QHBoxLayout(self.off_light_28)
        self.horizontalLayout_612.setObjectName(u"horizontalLayout_612")
        self.horizontalLayout_612.setContentsMargins(0, 0, 0, 0)
        self.pushButton_96 = QPushButton(self.off_light_28)
        ...
        self.pushButton_96.setFont(font20)
        self.pushButton_96.setIcon(icon9)
        self.pushButton_96.setIconSize(QSize(24, 24))

        self.horizontalLayout_612.addWidget(self.pushButton_96)

        self.i_o_group_1_switch_23.addWidget(self.off_light_28)
        self.on_light_28 = QWidget()
        self.on_light_28.setObjectName(u"on_light_28")
        self.horizontalLayout_613 = QHBoxLayout(self.on_light_28)
        self.horizontalLayout_613.setObjectName(u"horizontalLayout_613")
        self.horizontalLayout_613.setContentsMargins(0, 0, 0, 0)
        self.pushButton_97 = QPushButton(self.on_light_28)
        ...
        self.pushButton_97.setFont(font21)
        self.pushButton_97.setIcon(icon10)
        self.pushButton_97.setIconSize(QSize(24, 24))

        self.horizontalLayout_613.addWidget(self.pushButton_97)

        self.i_o_group_1_switch_23.addWidget(self.on_light_28)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_23, 8, 2, 1, 1)

        self.i_o_group_1_switch_14 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_14.setObjectName(u"i_o_group_1_switch_14")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_14.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_14.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_14.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_20 = QWidget()
        self.off_light_20.setObjectName(u"off_light_20")
        self.horizontalLayout_596 = QHBoxLayout(self.off_light_20)
        self.horizontalLayout_596.setObjectName(u"horizontalLayout_596")
        self.horizontalLayout_596.setContentsMargins(0, 0, 0, 0)
        self.pushButton_80 = QPushButton(self.off_light_20)
        ...
        self.pushButton_80.setFont(font20)
        self.pushButton_80.setIcon(icon9)
        self.pushButton_80.setIconSize(QSize(24, 24))

        self.horizontalLayout_596.addWidget(self.pushButton_80)

        self.i_o_group_1_switch_14.addWidget(self.off_light_20)
        self.on_light_20 = QWidget()
        self.on_light_20.setObjectName(u"on_light_20")
        self.horizontalLayout_597 = QHBoxLayout(self.on_light_20)
        self.horizontalLayout_597.setObjectName(u"horizontalLayout_597")
        self.horizontalLayout_597.setContentsMargins(0, 0, 0, 0)
        self.pushButton_81 = QPushButton(self.on_light_20)
        ...
        self.pushButton_81.setFont(font21)
        self.pushButton_81.setIcon(icon10)
        self.pushButton_81.setIconSize(QSize(24, 24))

        self.horizontalLayout_597.addWidget(self.pushButton_81)

        self.i_o_group_1_switch_14.addWidget(self.on_light_20)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_14, 2, 2, 1, 1)

        self.i_o_group_1_switch_15 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_15.setObjectName(u"i_o_group_1_switch_15")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_15.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_15.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_15.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_21 = QWidget()
        self.off_light_21.setObjectName(u"off_light_21")
        self.horizontalLayout_598 = QHBoxLayout(self.off_light_21)
        self.horizontalLayout_598.setObjectName(u"horizontalLayout_598")
        self.horizontalLayout_598.setContentsMargins(0, 0, 0, 0)
        self.pushButton_82 = QPushButton(self.off_light_21)
        ...
        self.pushButton_82.setFont(font20)
        self.pushButton_82.setIcon(icon9)
        self.pushButton_82.setIconSize(QSize(24, 24))

        self.horizontalLayout_598.addWidget(self.pushButton_82)

        self.i_o_group_1_switch_15.addWidget(self.off_light_21)
        self.on_light_21 = QWidget()
        self.on_light_21.setObjectName(u"on_light_21")
        self.horizontalLayout_599 = QHBoxLayout(self.on_light_21)
        self.horizontalLayout_599.setObjectName(u"horizontalLayout_599")
        self.horizontalLayout_599.setContentsMargins(0, 0, 0, 0)
        self.pushButton_83 = QPushButton(self.on_light_21)
        ...
        self.pushButton_83.setFont(font21)
        self.pushButton_83.setIcon(icon10)
        self.pushButton_83.setIconSize(QSize(24, 24))

        self.horizontalLayout_599.addWidget(self.pushButton_83)

        self.i_o_group_1_switch_15.addWidget(self.on_light_21)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_15, 4, 2, 1, 1)

        self.i_o_group_1_switch_16 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_16.setObjectName(u"i_o_group_1_switch_16")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_16.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_16.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_16.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_22 = QWidget()
        self.off_light_22.setObjectName(u"off_light_22")
        self.horizontalLayout_600 = QHBoxLayout(self.off_light_22)
        self.horizontalLayout_600.setObjectName(u"horizontalLayout_600")
        self.horizontalLayout_600.setContentsMargins(0, 0, 0, 0)
        self.pushButton_84 = QPushButton(self.off_light_22)
        ...
        self.pushButton_84.setFont(font20)
        self.pushButton_84.setIcon(icon9)
        self.pushButton_84.setIconSize(QSize(24, 24))

        self.horizontalLayout_600.addWidget(self.pushButton_84)

        self.i_o_group_1_switch_16.addWidget(self.off_light_22)
        self.on_light_22 = QWidget()
        self.on_light_22.setObjectName(u"on_light_22")
        self.horizontalLayout_601 = QHBoxLayout(self.on_light_22)
        self.horizontalLayout_601.setObjectName(u"horizontalLayout_601")
        self.horizontalLayout_601.setContentsMargins(0, 0, 0, 0)
        self.pushButton_85 = QPushButton(self.on_light_22)
        ...
        self.pushButton_85.setFont(font21)
        self.pushButton_85.setIcon(icon10)
        self.pushButton_85.setIconSize(QSize(24, 24))

        self.horizontalLayout_601.addWidget(self.pushButton_85)

        self.i_o_group_1_switch_16.addWidget(self.on_light_22)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_16, 5, 2, 1, 1)

        self.i_o_group_1_switch_17 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_17.setObjectName(u"i_o_group_1_switch_17")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_17.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_17.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_17.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_23 = QWidget()
        self.off_light_23.setObjectName(u"off_light_23")
        self.horizontalLayout_602 = QHBoxLayout(self.off_light_23)
        self.horizontalLayout_602.setObjectName(u"horizontalLayout_602")
        self.horizontalLayout_602.setContentsMargins(0, 0, 0, 0)
        self.pushButton_86 = QPushButton(self.off_light_23)
        ...
        self.pushButton_86.setFont(font20)
        self.pushButton_86.setIcon(icon9)
        self.pushButton_86.setIconSize(QSize(24, 24))

        self.horizontalLayout_602.addWidget(self.pushButton_86)

        self.i_o_group_1_switch_17.addWidget(self.off_light_23)
        self.on_light_23 = QWidget()
        self.on_light_23.setObjectName(u"on_light_23")
        self.horizontalLayout_603 = QHBoxLayout(self.on_light_23)
        self.horizontalLayout_603.setObjectName(u"horizontalLayout_603")
        self.horizontalLayout_603.setContentsMargins(0, 0, 0, 0)
        self.pushButton_87 = QPushButton(self.on_light_23)
        ...
        self.pushButton_87.setFont(font21)
        self.pushButton_87.setIcon(icon10)
        self.pushButton_87.setIconSize(QSize(24, 24))

        self.horizontalLayout_603.addWidget(self.pushButton_87)

        self.i_o_group_1_switch_17.addWidget(self.on_light_23)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_17, 6, 2, 1, 1)

        self.i_o_group_1_switch_18 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_18.setObjectName(u"i_o_group_1_switch_18")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_18.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_18.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_18.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_24 = QWidget()
        self.off_light_24.setObjectName(u"off_light_24")
        self.horizontalLayout_604 = QHBoxLayout(self.off_light_24)
        self.horizontalLayout_604.setObjectName(u"horizontalLayout_604")
        self.horizontalLayout_604.setContentsMargins(0, 0, 0, 0)
        self.pushButton_88 = QPushButton(self.off_light_24)
        ...
        self.pushButton_88.setFont(font20)
        self.pushButton_88.setIcon(icon9)
        self.pushButton_88.setIconSize(QSize(24, 24))

        self.horizontalLayout_604.addWidget(self.pushButton_88)

        self.i_o_group_1_switch_18.addWidget(self.off_light_24)
        self.on_light_24 = QWidget()
        self.on_light_24.setObjectName(u"on_light_24")
        self.horizontalLayout_605 = QHBoxLayout(self.on_light_24)
        self.horizontalLayout_605.setObjectName(u"horizontalLayout_605")
        self.horizontalLayout_605.setContentsMargins(0, 0, 0, 0)
        self.pushButton_89 = QPushButton(self.on_light_24)
        ...
        self.pushButton_89.setFont(font21)
        self.pushButton_89.setIcon(icon10)
        self.pushButton_89.setIconSize(QSize(24, 24))

        self.horizontalLayout_605.addWidget(self.pushButton_89)

        self.i_o_group_1_switch_18.addWidget(self.on_light_24)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_18, 1, 2, 1, 1)

        self.i_o_group_1_switch_19 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_19.setObjectName(u"i_o_group_1_switch_19")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_19.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_19.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_19.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_2 = QWidget()
        self.off_light_2.setObjectName(u"off_light_2")
        self.horizontalLayout_472 = QHBoxLayout(self.off_light_2)
        self.horizontalLayout_472.setObjectName(u"horizontalLayout_472")
        self.horizontalLayout_472.setContentsMargins(0, 0, 0, 0)
        self.pushButton_45 = QPushButton(self.off_light_2)
        ...
        self.horizontalLayout_472.addWidget(self.pushButton_45)

        self.i_o_group_1_switch_19.addWidget(self.off_light_2)
        self.on_light_2 = QWidget()
        self.on_light_2.setObjectName(u"on_light_2")
        self.horizontalLayout_475 = QHBoxLayout(self.on_light_2)
        self.horizontalLayout_475.setObjectName(u"horizontalLayout_475")
        self.horizontalLayout_475.setContentsMargins(0, 0, 0, 0)
        self.pushButton_46 = QPushButton(self.on_light_2)
        ...
        self.pushButton_46.setFont(font21)
        self.pushButton_46.setIcon(icon10)
        self.pushButton_46.setIconSize(QSize(24, 24))

        self.horizontalLayout_475.addWidget(self.pushButton_46)

        self.i_o_group_1_switch_19.addWidget(self.on_light_2)
        self.warning_light_2 = QWidget()
        self.warning_light_2.setObjectName(u"warning_light_2")
        self.horizontalLayout_50 = QHBoxLayout(self.warning_light_2)
        self.horizontalLayout_50.setObjectName(u"horizontalLayout_50")
        self.horizontalLayout_50.setContentsMargins(0, 0, 0, 0)
        self.pushButton_47 = QPushButton(self.warning_light_2)
        ...
        self.pushButton_47.setFont(font21)
        icon21 = QIcon()
        ...
        self.horizontalLayout_50.addWidget(self.pushButton_47)

        self.i_o_group_1_switch_19.addWidget(self.warning_light_2)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_19, 0, 2, 1, 1)

        self.serial_name_2 = QLabel(self.i_o_group_4)
        self.serial_name_2.setObjectName(u"serial_name_2")
        self.serial_name_2.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_2, 1, 0, 1, 1)

        self.i_o_group_1_switch_20 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_20.setObjectName(u"i_o_group_1_switch_20")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_20.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_20.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_20.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_25 = QWidget()
        self.off_light_25.setObjectName(u"off_light_25")
        self.horizontalLayout_606 = QHBoxLayout(self.off_light_25)
        self.horizontalLayout_606.setObjectName(u"horizontalLayout_606")
        self.horizontalLayout_606.setContentsMargins(0, 0, 0, 0)
        self.pushButton_90 = QPushButton(self.off_light_25)
        ...
        self.pushButton_90.setFont(font20)
        self.pushButton_90.setIcon(icon9)
        self.pushButton_90.setIconSize(QSize(24, 24))

        self.horizontalLayout_606.addWidget(self.pushButton_90)

        self.i_o_group_1_switch_20.addWidget(self.off_light_25)
        self.on_light_25 = QWidget()
        self.on_light_25.setObjectName(u"on_light_25")
        self.horizontalLayout_607 = QHBoxLayout(self.on_light_25)
        self.horizontalLayout_607.setObjectName(u"horizontalLayout_607")
        self.horizontalLayout_607.setContentsMargins(0, 0, 0, 0)
        self.pushButton_91 = QPushButton(self.on_light_25)
        ...
        self.pushButton_91.setFont(font21)
        self.pushButton_91.setIcon(icon10)
        self.pushButton_91.setIconSize(QSize(24, 24))

        self.horizontalLayout_607.addWidget(self.pushButton_91)

        self.i_o_group_1_switch_20.addWidget(self.on_light_25)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_20, 3, 2, 1, 1)

        self.serial_name_3 = QLabel(self.i_o_group_4)
        self.serial_name_3.setObjectName(u"serial_name_3")
        self.serial_name_3.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_3, 2, 0, 1, 1)

        self.i_o_group_1_switch_21 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_21.setObjectName(u"i_o_group_1_switch_21")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_21.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_21.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_21.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_26 = QWidget()
        self.off_light_26.setObjectName(u"off_light_26")
        self.horizontalLayout_608 = QHBoxLayout(self.off_light_26)
        self.horizontalLayout_608.setObjectName(u"horizontalLayout_608")
        self.horizontalLayout_608.setContentsMargins(0, 0, 0, 0)
        self.pushButton_92 = QPushButton(self.off_light_26)
        ...
        self.pushButton_92.setFont(font20)
        self.pushButton_92.setIcon(icon9)
        self.pushButton_92.setIconSize(QSize(24, 24))

        self.horizontalLayout_608.addWidget(self.pushButton_92)

        self.i_o_group_1_switch_21.addWidget(self.off_light_26)
        self.on_light_26 = QWidget()
        self.on_light_26.setObjectName(u"on_light_26")
        self.horizontalLayout_609 = QHBoxLayout(self.on_light_26)
        self.horizontalLayout_609.setObjectName(u"horizontalLayout_609")
        self.horizontalLayout_609.setContentsMargins(0, 0, 0, 0)
        self.pushButton_93 = QPushButton(self.on_light_26)
        ...
        self.pushButton_93.setFont(font21)
        self.pushButton_93.setIcon(icon10)
        self.pushButton_93.setIconSize(QSize(24, 24))

        self.horizontalLayout_609.addWidget(self.pushButton_93)

        self.i_o_group_1_switch_21.addWidget(self.on_light_26)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_21, 7, 2, 1, 1)

        self.serial_name_6 = QLabel(self.i_o_group_4)
        self.serial_name_6.setObjectName(u"serial_name_6")
        self.serial_name_6.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_6, 5, 0, 1, 1)

        self.serial_name_4 = QLabel(self.i_o_group_4)
        self.serial_name_4.setObjectName(u"serial_name_4")
        self.serial_name_4.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_4, 3, 0, 1, 1)

        self.serial_name_7 = QLabel(self.i_o_group_4)
        self.serial_name_7.setObjectName(u"serial_name_7")
        self.serial_name_7.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_7, 6, 0, 1, 1)

        self.serial_name_5 = QLabel(self.i_o_group_4)
        self.serial_name_5.setObjectName(u"serial_name_5")
        self.serial_name_5.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_5, 4, 0, 1, 1)

        self.serial_name_8 = QLabel(self.i_o_group_4)
        self.serial_name_8.setObjectName(u"serial_name_8")
        self.serial_name_8.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_8, 7, 0, 1, 1)

        self.serial_name_11 = QLabel(self.i_o_group_4)
        self.serial_name_11.setObjectName(u"serial_name_11")
        self.serial_name_11.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_11, 10, 0, 1, 1)

        self.serial_name_12 = QLabel(self.i_o_group_4)
        self.serial_name_12.setObjectName(u"serial_name_12")
        self.serial_name_12.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_12, 11, 0, 1, 1)

        self.i_o_group_1_switch_22 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_22.setObjectName(u"i_o_group_1_switch_22")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_22.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_22.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_22.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_27 = QWidget()
        self.off_light_27.setObjectName(u"off_light_27")
        self.horizontalLayout_610 = QHBoxLayout(self.off_light_27)
        self.horizontalLayout_610.setObjectName(u"horizontalLayout_610")
        self.horizontalLayout_610.setContentsMargins(0, 0, 0, 0)
        self.pushButton_94 = QPushButton(self.off_light_27)
        ...
        self.pushButton_94.setFont(font20)
        self.pushButton_94.setIcon(icon9)
        self.pushButton_94.setIconSize(QSize(24, 24))

        self.horizontalLayout_610.addWidget(self.pushButton_94)

        self.i_o_group_1_switch_22.addWidget(self.off_light_27)
        self.on_light_27 = QWidget()
        self.on_light_27.setObjectName(u"on_light_27")
        self.horizontalLayout_611 = QHBoxLayout(self.on_light_27)
        self.horizontalLayout_611.setObjectName(u"horizontalLayout_611")
        self.horizontalLayout_611.setContentsMargins(0, 0, 0, 0)
        self.pushButton_95 = QPushButton(self.on_light_27)
        ...
        self.pushButton_95.setFont(font21)
        self.pushButton_95.setIcon(icon10)
        self.pushButton_95.setIconSize(QSize(24, 24))

        self.horizontalLayout_611.addWidget(self.pushButton_95)

        self.i_o_group_1_switch_22.addWidget(self.on_light_27)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_22, 10, 2, 1, 1)

        self.i_o_group_1_switch_26 = QStackedWidget(self.i_o_group_4)
        self.i_o_group_1_switch_26.setObjectName(u"i_o_group_1_switch_26")
        sizePolicy.setHeightForWidth(self.i_o_group_1_switch_26.sizePolicy().hasHeightForWidth())
        self.i_o_group_1_switch_26.setSizePolicy(sizePolicy)
        self.i_o_group_1_switch_26.setStyleSheet(u"QWidget{\n"
"	border: none;\n"
"}")
        self.off_light_31 = QWidget()
        self.off_light_31.setObjectName(u"off_light_31")
        self.horizontalLayout_618 = QHBoxLayout(self.off_light_31)
        self.horizontalLayout_618.setObjectName(u"horizontalLayout_618")
        self.horizontalLayout_618.setContentsMargins(0, 0, 0, 0)
        self.pushButton_102 = QPushButton(self.off_light_31)
        ...
        self.pushButton_102.setFont(font20)
        self.pushButton_102.setIcon(icon9)
        self.pushButton_102.setIconSize(QSize(24, 24))

        self.horizontalLayout_618.addWidget(self.pushButton_102)

        self.i_o_group_1_switch_26.addWidget(self.off_light_31)
        self.on_light_31 = QWidget()
        self.on_light_31.setObjectName(u"on_light_31")
        self.horizontalLayout_619 = QHBoxLayout(self.on_light_31)
        self.horizontalLayout_619.setObjectName(u"horizontalLayout_619")
        self.horizontalLayout_619.setContentsMargins(0, 0, 0, 0)
        self.pushButton_103 = QPushButton(self.on_light_31)
        ...
        self.pushButton_103.setFont(font21)
        self.pushButton_103.setIcon(icon10)
        self.pushButton_103.setIconSize(QSize(24, 24))

        self.horizontalLayout_619.addWidget(self.pushButton_103)

        self.i_o_group_1_switch_26.addWidget(self.on_light_31)

        self.gridLayout_8.addWidget(self.i_o_group_1_switch_26, 12, 2, 1, 1)

        self.i_a_value = QDoubleSpinBox(self.i_o_group_4)
        self.i_a_value.setObjectName(u"i_a_value")
        sizePolicy.setHeightForWidth(self.i_a_value.sizePolicy().hasHeightForWidth())
        self.i_a_value.setSizePolicy(sizePolicy)
        self.i_a_value.setFont(font6)
        self.i_a_value.setAlignment(Qt.AlignCenter)
        self.i_a_value.setReadOnly(True)
        self.i_a_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.i_a_value.setDecimals(1)
        self.i_a_value.setMinimum(-1000.000000000000000)
        self.i_a_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.i_a_value, 3, 1, 1, 1)

        self.u_c_value = QDoubleSpinBox(self.i_o_group_4)
        self.u_c_value.setObjectName(u"u_c_value")
        sizePolicy.setHeightForWidth(self.u_c_value.sizePolicy().hasHeightForWidth())
        self.u_c_value.setSizePolicy(sizePolicy)
        self.u_c_value.setFont(font6)
        self.u_c_value.setAlignment(Qt.AlignCenter)
        self.u_c_value.setReadOnly(True)
        self.u_c_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.u_c_value.setDecimals(1)
        self.u_c_value.setMinimum(-1000.000000000000000)
        self.u_c_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.u_c_value, 2, 1, 1, 1)

        self.u_b_value = QDoubleSpinBox(self.i_o_group_4)
        self.u_b_value.setObjectName(u"u_b_value")
        sizePolicy.setHeightForWidth(self.u_b_value.sizePolicy().hasHeightForWidth())
        self.u_b_value.setSizePolicy(sizePolicy)
        self.u_b_value.setFont(font6)
        self.u_b_value.setAlignment(Qt.AlignCenter)
        self.u_b_value.setReadOnly(True)
        self.u_b_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.u_b_value.setDecimals(1)
        self.u_b_value.setMinimum(-1000.000000000000000)
        self.u_b_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.u_b_value, 1, 1, 1, 1)

        self.u_a_value = QDoubleSpinBox(self.i_o_group_4)
        self.u_a_value.setObjectName(u"u_a_value")
        sizePolicy.setHeightForWidth(self.u_a_value.sizePolicy().hasHeightForWidth())
        self.u_a_value.setSizePolicy(sizePolicy)
        self.u_a_value.setFont(font6)
        self.u_a_value.setAlignment(Qt.AlignCenter)
        self.u_a_value.setReadOnly(True)
        self.u_a_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.u_a_value.setDecimals(1)
        self.u_a_value.setMinimum(-1000.000000000000000)
        self.u_a_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.u_a_value, 0, 1, 1, 1)

        self.i_b_value = QDoubleSpinBox(self.i_o_group_4)
        self.i_b_value.setObjectName(u"i_b_value")
        sizePolicy.setHeightForWidth(self.i_b_value.sizePolicy().hasHeightForWidth())
        self.i_b_value.setSizePolicy(sizePolicy)
        self.i_b_value.setFont(font6)
        self.i_b_value.setAlignment(Qt.AlignCenter)
        self.i_b_value.setReadOnly(True)
        self.i_b_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.i_b_value.setDecimals(1)
        self.i_b_value.setMinimum(-1000.000000000000000)
        self.i_b_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.i_b_value, 4, 1, 1, 1)

        self.i_c_value = QDoubleSpinBox(self.i_o_group_4)
        self.i_c_value.setObjectName(u"i_c_value")
        sizePolicy.setHeightForWidth(self.i_c_value.sizePolicy().hasHeightForWidth())
        self.i_c_value.setSizePolicy(sizePolicy)
        self.i_c_value.setFont(font6)
        self.i_c_value.setAlignment(Qt.AlignCenter)
        self.i_c_value.setReadOnly(True)
        self.i_c_value.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.i_c_value.setDecimals(1)
        self.i_c_value.setMinimum(-1000.000000000000000)
        self.i_c_value.setMaximum(1000.000000000000000)

        self.gridLayout_8.addWidget(self.i_c_value, 5, 1, 1, 1)

        self.serial_name_1 = QLabel(self.i_o_group_4)
        self.serial_name_1.setObjectName(u"serial_name_1")
        self.serial_name_1.setFont(font22)

        self.gridLayout_8.addWidget(self.serial_name_1, 0, 0, 1, 1)
...
"image:url(:/Icons/Image_20260416155332_127_10.png)")
        ...
        self.connection_group.setFont(font7)
...
"}")
        ...
        font23.setBold(True)
        self.read_plc_label.setFont(font23)
...
"}")
        ...
        self.write_plc_label.setFont(font23)
...
"}")
        ...
        self.table_write_cycle.setFont(font7)
        ...
        self.write_table_label.setFont(font23)
...
"}")
        ...
        self.total_cycle_label_c.setFont(font23)
...
"}")
        ...
        self.total_cycle_label_b.setFont(font23)
...
"padding-left: 20px;")
        ...
        self.reset_cycle_c_btn.setFont(font19)
...
"padding-left: 20px;")
        ...
        self.reset_cycle_b_btn.setFont(font19)
...
"padding-right: 3px;")
        ...
        self.read_time_input.setFont(font7)
...
"padding-right: 3px;")
        ...
        self.write_time_input.setFont(font7)
...
"padding-left: 20px;")
        ...
        self.reset_cycle_a_btn.setFont(font19)
...
"}")
        ...
        self.total_cycle_label_a.setFont(font23)
...
"}")
        ...
        self.verticalLayout_28.setContentsMargins(0, 15, 0, 0)
...
"}")
        ...
        icon24 = QIcon()
        icon24.addFile(u":/Icons/search_2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.search_icon.setIcon(icon24)
...
"")
        ...
        icon25 = QIcon()
        icon25.addFile(u":/Icons/circle-xmark.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.clear_history_search.setIcon(icon25)
...
"}")
        icon26 = QIcon()
        icon26.addFile(u":/Icons/xlsx-file-format.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.export_all_tables_to_excel_btn.setIcon(icon26)
        ...
        self.list_history.setFont(font20)
...
"QScrollBar::add-line:horizontal, QScrollBar::sub-line:horizontal { width: 0px; }")
        ...
        self.list_history_2.setFont(font20)
...
"QScrollBar::add-line:horizontal, QScrollBar::sub-line:horizontal { width: 0px; }")
        ...
        self.verticalLayout_16 = QVBoxLayout(self.alarm_page)
        self.verticalLayout_16.setObjectName(u"verticalLayout_16")
        self.verticalLayout_16.setContentsMargins(0, 0, 0, 0)
        self.list_alarm = QTableWidget(self.alarm_page)
        if (self.list_alarm.columnCount() < 4):
            self.list_alarm.setColumnCount(4)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.list_alarm.setHorizontalHeaderItem(0, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.list_alarm.setHorizontalHeaderItem(1, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.list_alarm.setHorizontalHeaderItem(2, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.list_alarm.setHorizontalHeaderItem(3, __qtablewidgetitem21)
        self.list_alarm.setObjectName(u"list_alarm")
        self.list_alarm.setFont(font20)
        self.list_alarm.setStyleSheet(u"QTableWidget {\n"
"    background-color: #ffffff; border: 1px solid #BFC8D3; border-radius: 8px;\n"
"    gridline-color: #BFC8D3; color: #334155;\n"
"    selection-background-color: #dbeafe; selection-color: #1e40af; outline: none;\n"
"}\n"
...
"QScrollBar::add-line:horizontal, QScrollBar::sub-line:horizontal { width: 0px; }")
        ...
        self.verticalLayout_16.addWidget(self.list_alarm)

        self.stackedWidget_2.addWidget(self.alarm_page)
        ...
        self.i_o_group_1_switch_25.setCurrentIndex(0)
        self.i_o_group_1_switch_24.setCurrentIndex(0)
        self.i_o_group_1_switch_23.setCurrentIndex(0)
        self.i_o_group_1_switch_14.setCurrentIndex(0)
        self.i_o_group_1_switch_15.setCurrentIndex(0)
        self.i_o_group_1_switch_16.setCurrentIndex(0)
        self.i_o_group_1_switch_17.setCurrentIndex(0)
        self.i_o_group_1_switch_18.setCurrentIndex(0)
        self.i_o_group_1_switch_19.setCurrentIndex(0)
        self.i_o_group_1_switch_20.setCurrentIndex(0)
        self.i_o_group_1_switch_21.setCurrentIndex(0)
        self.i_o_group_1_switch_22.setCurrentIndex(0)
        self.i_o_group_1_switch_26.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.alarm_page_btn.setText(QCoreApplication.translate("MainWindow", u" Alarm", None))
        ...
        self.serial_name_13.setText(QCoreApplication.translate("MainWindow", u"P3 Count:", None))
        self.pushButton_98.setText("")
        self.pushButton_99.setText("")
        self.serial_name_10.setText(QCoreApplication.translate("MainWindow", u"P3 Heat:", None))
        self.serial_name_9.setText(QCoreApplication.translate("MainWindow", u"P2 Count:", None))
        ...
        self.serial_name_2.setText(QCoreApplication.translate("MainWindow", u"Ub", None))
        self.pushButton_90.setText("")
        self.pushButton_91.setText("")
        self.serial_name_3.setText(QCoreApplication.translate("MainWindow", u"Uc", None))
        self.pushButton_92.setText("")
        self.pushButton_93.setText("")
        self.serial_name_6.setText(QCoreApplication.translate("MainWindow", u"Ic", None))
        self.serial_name_4.setText(QCoreApplication.translate("MainWindow", u"Ia", None))
        self.serial_name_7.setText(QCoreApplication.translate("MainWindow", u"P2 Press:", None))
        self.serial_name_5.setText(QCoreApplication.translate("MainWindow", u"Ib", None))
        self.serial_name_8.setText(QCoreApplication.translate("MainWindow", u"P2 Oil:", None))
        self.serial_name_11.setText(QCoreApplication.translate("MainWindow", u"P3 Press:", None))
        self.serial_name_12.setText(QCoreApplication.translate("MainWindow", u"P3 Oil:", None))
        self.pushButton_94.setText("")
        self.pushButton_95.setText("")
        self.pushButton_102.setText("")
        self.pushButton_103.setText("")
        self.serial_name_1.setText(QCoreApplication.translate("MainWindow", u"Ua", None))
#if QT_CONFIG(tooltip)
        ...
        ___qtablewidgetitem18 = self.list_alarm.horizontalHeaderItem(0)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"No.", None))
        ___qtablewidgetitem19 = self.list_alarm.horizontalHeaderItem(1)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"Name.", None))
        ___qtablewidgetitem20 = self.list_alarm.horizontalHeaderItem(2)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"Time.", None))
        ___qtablewidgetitem21 = self.list_alarm.horizontalHeaderItem(3)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"Content", None))
    # retranslateUi
